  ...
  return (
    <div className="w-full pb-8">
      ...
      <div className="mb-10">
        ...
        <div className="bg-white dark:bg-[#2C2C2E] border border-black/[0.03] dark:border-white/5 rounded-[28px] overflow-hidden shadow-sm">
          <button 
            onClick={toggleTheme}
            className="w-full flex items-center justify-between p-5 hover:bg-slate-50 dark:hover:bg-[#343437] transition-colors border-b border-black/5 dark:border-white/5"
          >
